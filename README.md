...
Getting stored image in Base64 for particular graph node from dataset:  
 ![Getting stored image in Base64 for particular graph node for dataset](https://github.com/jperdek/automatedSPLEvolutionFramework/blob/master/misc/gettingBase64Hash.png)   
