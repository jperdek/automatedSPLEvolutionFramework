...
from server.apis.http.api.semantic_base.tools.turtle_constructor import (
    TurtleTriplesConstructor,
)
...
class NeosemanticsKnowledgeGraphApi:
    def init_graph_neosemantics(self, graph_knowledge_api: GraphKnowledgeBaseAPI):
        prefix_pointing_to_namespace_call = (
            TripleCallNeosemanticsFactory.define_prefix_pointing_to_namespace(
                "faspls",
                "https://jakubperdek-26e24f.gitlab.io/fully-automated-spls-schema.ttl",
            )
        )
        try:
        ...
        graph_knowledge_api.process_data_transaction_using_commands(
            TripleCallNeosemanticsFactory.init_semantic_graph()
        )
        graph_knowledge_api.process_data_transaction_using_commands(
    ...
    def init_new_evolution(
        ...
        new_evolution_knowledge_ttl = (
            TurtleTriplesConstructor.prepare_ttl_of_core_product_line_evolution(
                evolution_id,
        ...
        knowledge_ttl_call = TripleCallNeosemanticsFactory.import_from_text(
            new_evolution_knowledge_ttl, "Turtle"
        )
    ...
    def register_new_evolution_iteration(
        ...
        new_evolution_knowledge_ttl = (
            TurtleTriplesConstructor.prepare_ttl_of_diverse_representations(
                evolution_id,
    ...
    def register_new_product(
        ...
        new_evolution_knowledge_ttl = (
            TurtleTriplesConstructor.prepare_ttl_of_derived_product(
                evolved_product_line_id,
                code_location,
                graph_location,
                raster_location,
...
if __name__ == "__main__":
    ...
    evolved_script_path, evolution_configuration_path = (
        "/evolved_script",
        "/evolved_configuration",
    )
    ...
    code_location, graph_location, raster_location, vector_location = (
        "/code",
        "/graph",
        "/raster",
        "/vector",
    ...
    iteration2 = "2"
    code_location2, graph_location2, raster_location2, vector_location2 = (
        "/code2",
        "/graph2",
        "/raster2",
        "/vector2",
    ...
    neosemantics_knowledge_graph_api.register_new_evolution_iteration(
        graph_knowl_api,
        evolution_id,
        evolved_product_line_id2,
        iteration2,
        code_location2,
        graph_location2,
        raster_location2,
        vector_location2,
        variation_point_data_location2,
        evolved_script_id,
        evolved_script_path,
        evolved_product_line_id,
        import_variation_points,
    ...
    iteration3 = "3"
    code_location3, graph_location3, raster_location3, vector_location3 = (
        "/code3",
        "/graph3",
        "/raster3",
        "/vector3",
    ...
    neosemantics_knowledge_graph_api.register_new_evolution_iteration(
        graph_knowl_api,
        evolution_id,
        evolved_product_line_id3,
        iteration3,
        code_location3,
        graph_location3,
        raster_location3,
        vector_location3,
        variation_point_data_location3,
        evolved_script_id,
        evolved_script_path,
        evolved_product_line_id2,
        import_variation_points,
    ...
    neosemantics_knowledge_graph_api.init_new_evolution(
        graph_knowl_api,
        new_evolution_id,
        new_evolved_product_line_id,
        evolved_script_id,
        evolved_script_path,
        evolution_configuration_path=evolution_configuration_path,
        previous_evolution_id=evolution_id,
