...
class DatasetScreenshooter:
    ...
    def process_dataset(
        ...
        max_size: Optional[tuple] = (600, 600),
        added_borders: int = 35,
        canvas_id: str = "#game",
        ...
        for derivation_name in os.listdir(absolute_dataset_path):
            ...
            if os.path.isdir(project_path):
                ...
                image = self.screenshooter.take_screenshoot_according_locator(
                    focus_element_selector=canvas_id, timeout=browser_timeout
                )
                image_name = derivation_name + ".png"
                final_image_path = os.path.join(absolute_final_path, image_name)
                ImageProcessor.automatically_trim_and_save_image(
                    image, final_image_path, max_size, added_borders=added_borders
                )
...
if __name__ == "__main__":
    ...
    if test:
        ...
        dataset_screenshooter.process_dataset(
            ...
            final_location_path="./generated_dataset",
            max_size=None,
            canvas_id="#game",
