...
function drawLine(context, x1, y1, x2, y2, thickness) {
    console.log("LINE " + x1.toString() + ", " + y1.toString() + " ; "  + x2.toString() + ", " + y2.toString())
	context.beginPath();
...
function drawCircle(context, x, y, radius) {
	...
	console.log("CIRCLE " + x.toString() + ", " + y.toString() + " ; radius: "  + radius);
	context.closePath();
	context.fill();
}
...
$(function() {
	...
	drawWCurve(numberIterations, wcurve.moveRatio / 16, 200, 200, wcurve, context,
	        wcurve.direction.ALL, false, false, false, false);
});