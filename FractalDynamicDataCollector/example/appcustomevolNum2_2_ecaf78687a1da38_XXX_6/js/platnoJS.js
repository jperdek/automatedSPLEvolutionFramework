var aaa180a179244a47b00 = `var stackStub = [];
...
function saveState(context: CanvasRenderingContext2D) {
...
function loadState(context: CanvasRenderingContext2D) {
...
function propagateCoordinatesThreePositions2(context: CanvasRenderingContext2D, x: number, y: number) {
    try {
        pushData({ "fname": arguments.callee.toString().substring(0, arguments.callee.toString().split("(")[0].length), "className": "", "context": (typeof (context) === "object" || typeof (" + parameterName + ") === "function") ? "[Object]" : context, "x": (typeof (x) === "object" || typeof (" + parameterName + ") === "function") ? "[Object]" : x, "y": (typeof (y) === "object" || typeof (" + parameterName + ") === "function") ? "[Object]" : y });
    }
    catch (error) {
        return;
    }
...
export function drawCover6(context: CanvasRenderingContext2D) {
    try {
        pushData({ "fname": arguments.callee.toString().substring(0, arguments.callee.toString().split("(")[0].length), "className": "", "context": (typeof (context) === "object" || typeof (" + parameterName + ") === "function") ? "[Object]" : context });
    }
    catch (error) {
    ...
    console.log("1a " + context.currentX + " <----> " + context.currentY);
    console.log("1a " + context.currentX2 + " <----> " + context.currentY2);
    console.log("1a " + context.currentX3 + " <----> " + context.currentY3);
    console.log("1a " + context.currentX4 + " <----> " + context.currentY4);
    console.log("------------------------------------------------------");
    if (context.currentX !== undefined && context.currentY !== undefined &&
        context.currentX3 !== undefined && context.currentY3 !== undefined) {
        let radius = Math.abs(Math.abs(context.currentX) - Math.abs(context.currentX3));
        if (radius > 5) {
            radius = 5;
        }
        ...
        let x1 = context.currentX;
        let y1 = context.currentY;
        let x2 = context.currentX3 - context.currentX4;
        let y2 = context.currentY3 - context.currentY4;
        context.beginPath();
        context.moveTo(x1, y1 - radius);
        context.lineTo(x2, y2 - radius);
        context.lineTo(x2 + radius, y2);
...
export function drawCover5(context: CanvasRenderingContext2D) {
    ...
    if (context.currentX !== undefined && context.currentY !== undefined &&
        context.currentX2 !== undefined && context.currentY2 !== undefined &&
        context.currentX3 !== undefined && context.currentY3 !== undefined) {
        let radius = context.currentY - context.currentY2;
        let x1 = context.currentX;
        let y1 = context.currentY;
        let x2 = context.currentX3;
        let y2 = context.currentY3;
		...
		saveState(context);
        context.beginPath();
		context.strokeStyle = "rgba(250, 50, 250, .9)";
...
export function drawCover8(context: CanvasRenderingContext2D) {
    try {
        pushData({ "fname": arguments.callee.toString().substring(0, arguments.callee.toString().split("(")[0].length), "className": "", "context": (typeof (context) === "object" || typeof (" + parameterName + ") === "function") ? "[Object]" : context });
    }
    catch (error) {
	...
	context.currentX3 !== undefined && context.currentY3 !== undefined) {
		...
		context.fillStyle = "rgba(50, 100, 250, .9)";
		context.moveTo(x1, y1);
		context.lineTo(x2, y2);
		context.lineTo(x3, y3);
		context.lineTo(x4, y4);
