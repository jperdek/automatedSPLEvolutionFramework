...
public interface DebugInformation {
	 ...
	 */
	public static boolean SHOW_SELECTED_SYNTESIZED_CODE_CONSTRUCTS = true;
	
	/**
	 * Shows information about possible enhancements in form of warnings during the processing
	 */
	public static boolean SHOW_MISSING_EVOLUTION_ENHANCEMENTS = true;
	
	/**
	 * The exhaustive/detail information from various processes 
	 */
	public static boolean SHOW_POLLUTING_INFORMATION = false;		
	
	/**
	 * Show the structure and the content of some entities across the application
	 */
	public static boolean SHOW_CREATED_ENTITIES = false;
	
	/**
	 * Shows the information about exports
	 */
	public static boolean SHOW_INFORMATION_ABOUT_EXPORTS = false;
	 ...
	 */
	public static boolean SHOW_INITIAL_COPIED_INFORMATION = true; 
	
	/**
	 * Shows AST of added/incorporated/extendable code fragment into new derivation
	 */
	public static boolean SHOW_POSITIVE_VARIABILITY_INCREMENT_CODE_FRAGMENT = true; 
	
	/**
	 * Shows information about taken steps during evolution process - very descriptive and so much non-repetitive/concise
	 */
	public static boolean PROCESS_STEP_INFORMATION = true; 
	
	/**
	 * Shows information about derived project
	 */
	public static boolean SHOW_DERIVED_PROJECT_INFORMATION = true;
}
