...
public class EvolutionConfigurations {
	...
	public static EvolutionCoreSettings getMaximalSemanticOrientedConfiguration() {
		...
		ActualScriptVariablesToSubstituteConfiguration actualScriptVariablesToSubstituteConfiguration = new ActualScriptVariablesToSubstituteConfiguration(true);
		EvolutionCoreSettings maximalSemanticOrientedConfiguration = new EvolutionCoreSettings(evolutionCoreStrategies,
				...
				variationPointDivisioning, actualScriptVariablesToSubstituteConfiguration);
