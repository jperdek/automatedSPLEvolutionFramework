...
function drawCircle(context: CanvasRenderingContext2D, cordX: number, cordY: number, radius: number) {
	...
	console.log(context.currentX);
		console.log(context.currentY);
	context.closePath();
	context.fill();
}
...
export class FiveSideFractal {
  ...
  */
  drawFiveStar(context: CanvasRenderingContext2D, radius: number, iterations: number, thickness: number) {
    const fiveSideMapInfo = new FiveSideMapInfo(context, 5, 300, 300, 400);
...
export function drawAnkletModMain(context: CanvasRenderingContext2D, radius: number, iterations: number, thickness: number): void {
  let fiveSideFractal = new FiveSideFractal();
	fiveSideFractal.drawFiveStar(context, radius, iterations, thickness);
}

/*
export function drawCircle(context: CanvasRenderingContext2D, radius: number) {
	context.fillStyle = "rgba(200, 200, 100, .9)";
	context.beginPath();
	context.arc(window.cordX, window.cordY, radius, 0, Math.PI*2, true);
	context.closePath();
	context.fill();
}*/
